...
## Project Structure
    ...
    ├── cnbc_international_38280  # Django project configurations
...
1. Clone this repo and `cd cnbc_international_38280`
...
2. Clone this repo and `cd cnbc_international_38280`
